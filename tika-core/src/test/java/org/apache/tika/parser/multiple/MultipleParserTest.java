...
argument_list|)
expr_stmt|;
comment|// TODO Other policies
comment|// Check the Discard policy
comment|// First with the last parser being a "real" one
comment|// TODO
comment|// Then with the last parser being one that emits no metadata
comment|// TODO
