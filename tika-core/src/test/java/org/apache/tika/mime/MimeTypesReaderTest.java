...
name|ClassLoader
block|{     }
comment|/**      * TIKA-2460 Test loading of custom-mimetypes.xml from sys prop.      */
annotation|@
name|Test
specifier|public
name|void
name|testExternalMimeTypes
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
literal|"src/test/resources/org/apache/tika/mime/external-mimetypes.xml"
argument_list|)
expr_stmt|;
name|MimeTypes
name|mimeTypes
...
name|RESOURCE_NAME_KEY
argument_list|,
literal|"test.external.mime.type"
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
literal|"external/mime-type"
argument_list|,
name|mimeTypes
operator|.
name|detect
