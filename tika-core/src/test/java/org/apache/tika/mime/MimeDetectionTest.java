...
specifier|public
name|void
name|testDetectionWithoutContent
parameter_list|()
throws|throws
name|IOException
block|{
name|testUrlWithoutContent
argument_list|(
literal|"text/html"
argument_list|,
literal|"test.html"
...
literal|"text/html"
argument_list|,
literal|"http://test.com/test.html"
argument_list|)
expr_stmt|;
name|testUrlWithoutContent
argument_list|(
literal|"text/plain"
argument_list|,
literal|"http://test.com/test.txt"
argument_list|)
expr_stmt|;
comment|// In case the url contains a filename referencing a server-side scripting language,
comment|// it gives us no clue concerning the actual mime type of the response
name|testUrlWithoutContent
argument_list|(
literal|"application/octet-stream"
argument_list|,
literal|"http://test.com/test.php"
argument_list|)
expr_stmt|;
name|testUrlWithoutContent
argument_list|(
literal|"application/octet-stream"
argument_list|,
literal|"http://test.com/test.cgi"
argument_list|)
expr_stmt|;
name|testUrlWithoutContent
argument_list|(
literal|"application/octet-stream"
argument_list|,
literal|"http://test.com/test.jsp"
argument_list|)
expr_stmt|;
comment|// But in case the protocol is not http or https, the script is probably not interpreted
name|testUrlWithoutContent
argument_list|(
literal|"text/x-php"
argument_list|,
literal|"ftp://test.com/test.php"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|url
operator|+
literal|" is not properly detected using only resource name"
argument_list|,
name|expected
argument_list|,
name|mime
