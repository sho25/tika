...
name|getConfig
argument_list|(
literal|"TIKA-1509-multiple-fallback.xml"
argument_list|)
decl_stmt|;
name|CompositeParser
name|parser
...
specifier|public
name|void
name|testXMLReaderUtils
parameter_list|()
throws|throws
name|Exception
block|{
comment|//pool size may have been reset already by an
comment|//earlier test.  Can't test for default here.
name|assertEquals
argument_list|(
name|XMLReaderUtils
operator|.
...
argument_list|)
expr_stmt|;
comment|//make sure that detection on this file actually works with
comment|//default expansions
name|assertEquals
argument_list|(
...
name|getConfig
argument_list|(
literal|"TIKA-2732-xmlreaderutils.xml"
argument_list|)
decl_stmt|;
try|try
block|{
...
argument_list|)
expr_stmt|;
comment|//make sure that there's actually a change in behavior
name|assertEquals
argument_list|(
literal|"text/plain"
argument_list|,
...
specifier|public
name|void
name|testXMLReaderUtilsException
parameter_list|()
throws|throws
name|Exception
block|{
name|getConfig
argument_list|(
literal|"TIKA-2732-xmlreaderutils-exc.xml"
argument_list|)
expr_stmt|;
block|}
block|}
