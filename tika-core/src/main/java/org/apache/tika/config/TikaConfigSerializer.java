...
argument_list|()
decl_stmt|;
comment|// TODO Implement the reverse of ExecutorServiceXmlLoader
comment|// TODO Make it possible to detect if we have the default executor
comment|// TODO Make it possible to get the current values from ConfigurableThreadPoolExecutor
block|}
specifier|private
specifier|static
name|void
...
name|createComment
argument_list|(
literal|"for example:<encodingDetectors><encodingDetector class=\""
operator|+
literal|"org.apache.tika.detect.DefaultEncodingDetector\"></encodingDetectors>"
argument_list|)
decl_stmt|;
name|rootElement
operator|.
...
condition|)
block|{
comment|// Always output the parsers that go into the multiple
name|children
operator|=
operator|(
operator|(
...
argument_list|)
expr_stmt|;
comment|// TODO Output configurable parameters in a genric way, see TIKA-1508
if|if
condition|(
name|parser
operator|instanceof
