...
name|getBoolean
argument_list|(
literal|"org.apache.tika.service.error.warn"
argument_list|)
condition|?
name|LoadErrorHandler
operator|.
...
return|;
block|}
comment|/**      * Returns the handler for problems with initializables      *      * @return handler for problems with initializables      * @since Apache Tika 1.15.1      */
specifier|public
name|InitializableProblemHandler
...
block|}
block|}
comment|/**      *      * @return ClassLoader used by this ServiceLoader      * @see #getContextClassLoader() for the context's ClassLoader      * @since Apache Tika 1.15.1      */
specifier|public
name|ClassLoader
name|getLoader
parameter_list|()
