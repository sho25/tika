...
block|}
block|}
comment|/**      * Returns all the available service providers of the given type      * that aren't blacklisted.      *      * @param iface service provider interface      * @return available service providers      */
specifier|public
parameter_list|<
name|T
parameter_list|>
...
name|blacklist
init|=
name|loadStaticServiceProvidersBlacklist
argument_list|(
name|iface
argument_list|)
decl_stmt|;
...
return|;
block|}
comment|/**      * Returns the blacklisted static service providers of the given type, without      * attempting to load them.      * The providers are loaded using the service provider mechanism using      * the configured class loader (if any).      *      * @since Apache Tika 1.8      * @param iface service provider interface      * @return static list of uninitialised blacklisted service providers.      *      */
specifier|protected
parameter_list|<
name|T
parameter_list|>
...
name|String
argument_list|>
name|identifyStaticServiceProvidersBlacklist
parameter_list|(
name|Class
argument_list|<
name|T
...
return|;
block|}
comment|/**      * Returns the available blacklisted static service providers of the given type.      * The providers are loaded using the service provider mechanism using      * the configured class loader (if any). The returned list is newly      * allocated and may be freely modified by the caller.      *      * @since Apache Tika 1.8      * @param iface service provider interface      * @return blacklisted static service providers      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
