...
expr_stmt|;
block|}
comment|//make sure to call this after set entity expansions
name|attr
operator|=
name|child
operator|.
...
name|loaded
return|;
comment|// Get any parameters / settings for the parser
name|Map
argument_list|<
name|String
argument_list|,
