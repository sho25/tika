...
argument_list|()
decl_stmt|;
comment|// Should be only zero or one<parsers> tag
name|NodeList
name|nodes
init|=
name|element
...
name|TikaException
argument_list|(
literal|"Properties may not contain multiple Parsers entries"
argument_list|)
throw|;
block|}
elseif|else
...
condition|)
block|{
comment|// Find only the direct child parser objects
name|Node
name|parsersE
init|=
name|nodes
