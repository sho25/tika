...
parameter_list|()
block|{     }
comment|/**      * Returns the contents of the given file, and sets any related metadata      * entries.      *      * @param file the file to be read      * @param metadata where the file metadata is stored      * @return file content      * @throws FileNotFoundException if the file does not exist      */
specifier|public
specifier|static
name|InputStream
name|getInputStream
