...
name|UTF_8
decl_stmt|;
comment|/**      * The default buffer size to use for the skip() methods.      */
specifier|private
specifier|static
specifier|final
name|int
...
condition|)
block|{
comment|// See https://issues.apache.org/jira/browse/IO-203 for why we use read() rather than delegating to skip()
specifier|final
name|long
name|n
init|=
