...
literal|null
decl_stmt|;
comment|/**      * Sets the directory to be used for the temporary files created by      * the {@link #createTempFile()} method.      *      * @param tempFileDir temporary file directory,      *                    or<code>null</code> for the system default      */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * Sets the directory to be used for the temporary files created by      * the {@link #createTempFile()} method.      *      * @param tempFileDir temporary file directory,      *                    or<code>null</code> for the system default      * @see #setTemporaryFileDirectory(Path)      */
specifier|public
name|void
name|setTemporaryFileDirectory
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a temporary file that will automatically be deleted when      * the {@link #close()} method is called, returning its path.      *      * @return Path to created temporary file that will be deleted after closing      * @throws IOException      */
specifier|public
name|Path
name|createTempFile
parameter_list|()
...
return|;
block|}
comment|/**      * Creates and returns a temporary file that will automatically be      * deleted when the {@link #close()} method is called.      *      * @return Created temporary file that'll be deleted after closing      * @throws IOException      * @see #createTempFile()      */
specifier|public
name|File
...
return|;
block|}
comment|/**      * Closes all tracked resources. The resources are closed in reverse order      * from how they were added.      *<p>      * Any suppressed exceptions from managed resources are collected and      * then added to the first thrown exception, which is re-thrown once      * all the resources have been closed.      *      * @throws IOException if one or more of the tracked resources      *                     could not be closed      */
specifier|public
name|void
name|close
parameter_list|()
