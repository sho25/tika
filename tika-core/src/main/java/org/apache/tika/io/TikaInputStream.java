...
return|;
block|}
comment|/**      * Creates a TikaInputStream from the file at the given path.      *<p>      * Note that you must always explicitly close the returned stream to      * prevent leaking open file handles.      *      * @param path input file      * @return a TikaInputStream instance      * @throws IOException if an I/O error occurs      */
specifier|public
specifier|static
name|TikaInputStream
name|get
...
return|;
block|}
comment|/**      * Creates a TikaInputStream from the file at the given path. The file name      * and length are stored as input metadata in the given metadata instance.      *<p>      * Note that you must always explicitly close the returned stream to      * prevent leaking open file handles.      *      * @param path input file      * @param metadata metadata instance      * @return a TikaInputStream instance      * @throws IOException if an I/O error occurs      */
specifier|public
specifier|static
name|TikaInputStream
name|get
...
return|;
block|}
comment|/**      * If the user created this TikaInputStream with a file,      * the original file will be returned.  If not, the entire stream      * will be spooled to a temporary file which will be deleted      * upon the close of this TikaInputStream      * @return      * @throws IOException      */
specifier|public
name|Path
name|getPath
parameter_list|()
...
argument_list|()
expr_stmt|;
comment|// updates length internally
block|}
return|return
name|length
return|;
