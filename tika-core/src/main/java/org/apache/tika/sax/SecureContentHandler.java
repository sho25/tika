...
literal|0
decl_stmt|;
comment|/**      * Current number of nested&lt;div class="package-entr"&gt; elements.      */
specifier|private
name|LinkedList
argument_list|<
name|Integer
argument_list|>
name|packageEntryDepths
init|=
operator|new
name|LinkedList
argument_list|<
...
literal|100
decl_stmt|;
comment|/**      * Maximum package entry nesting level.      */
specifier|private
name|int
name|maxPackageEntryDepth
init|=
literal|10
decl_stmt|;
...
return|;
block|}
comment|/**      * Sets the maximum package entry nesting level. If this depth level is      * exceeded then an exception gets thrown.      *      * @param depth maximum package entry nesting level      */
specifier|public
name|void
name|setMaximumPackageEntryDepth
parameter_list|(
name|int
name|depth
parameter_list|)
...
expr_stmt|;
block|}
comment|/**      * Returns the maximum package entry nesting level.      *      * @return maximum package entry nesting level      */
specifier|public
name|int
...
argument_list|()
operator|+
literal|" levels of package entry nesting"
argument_list|)
throw|;
block|}
block|}
