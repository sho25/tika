...
block|{
comment|/**      * Tries to parse string into handler type.  Returns default if string is null or      * parse fails.      *<p/>      * Options: xml, html, text, body, ignore (no content)      *      * @param handlerTypeName string to parse      * @param defaultType type to return if parse fails      * @return handler type      */
specifier|public
specifier|static
name|HANDLER_TYPE
...
argument_list|(
literal|"couldn't find charset for name: "
operator|+
name|charset
argument_list|)
throw|;
