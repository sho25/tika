...
control|)
block|{
comment|//short circuit via OverrideDetector
comment|//can't rely on ordering because subsequent detector may
comment|//change Override's to a specialization of Override's
if|if
condition|(
name|detector
operator|instanceof
