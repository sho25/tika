...
name|EMPTY_MAP
decl_stmt|;
comment|/**      * Map of configurable arguments      */
specifier|private
specifier|final
name|Map
argument_list|<
...
return|;
block|}
comment|/**      * @param clazz class associated with given param name      * @param value value      */
specifier|public
name|void
name|setParam
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Gets the value associated with given class and parameter      * @param clazz class      * @param key parameter name      * @return param value or null if the clazz or key doesn't exist      */
specifier|public
name|Param
argument_list|<
name|?
...
return|;
block|}
comment|/**      * Gets all the params for the specified class      * @param clazz class for which to grab the params      * @return map of key values or null if nothing has been specified      */
specifier|public
name|Map
argument_list|<
name|String
...
return|;
block|}
comment|/**      * Checks if parameter is available      * @param key parameter name      * @return true if parameter is available, false otherwise      */
specifier|public
name|boolean
name|hasParam
parameter_list|(
...
argument_list|)
expr_stmt|;
name|tryToSetSAXFeatureOnDOMFactory
argument_list|(
name|documentBuilderFactory
argument_list|,
name|XMLConstants
...
block|}
block|}
comment|/**      * Returns the StAX input factory specified in this parsing context.      * If a factory is not explicitly specified, then a default factory      * instance is created and returned. The default factory instance is      * configured to be namespace-aware and to apply reasonable security      * using the {@link #IGNORING_STAX_ENTITY_RESOLVER}.      *      * @since Apache Tika 1.13      * @return StAX input factory      */
specifier|public
name|XMLInputFactory
