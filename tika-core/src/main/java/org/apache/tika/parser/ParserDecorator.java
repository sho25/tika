...
argument_list|()
expr_stmt|;
comment|// Try each parser in turn
for|for
control|(
name|Parser
name|p
...
parameter_list|)
block|{
comment|// TODO How to log / record this failure?
block|}
