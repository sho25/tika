...
argument_list|)
decl_stmt|;
comment|//store the handler that was used before this parse
comment|//so that you can return it back to its state at the end of this parse
name|ContentHandler
name|preContextHandler
init|=
name|secureContentHandler
operator|.
name|handler
...
expr_stmt|;
block|}
comment|/**          *  Bypass the SecureContentHandler...          *          *  This handler only looks at zip bomb via zip expansion.          *  Users should be protected within entries against nested          *  nested xml entities.  We don't want to carry          *  those stats _across_ entries.          *          * @param uri          * @param localName          * @param name          * @param atts          * @throws SAXException          */
annotation|@
name|Override
specifier|public
name|void
