...
block|}
block|}
comment|/**      * Returns a new transformer      *       * The transformer instance is configured to to use      * {@link XMLConstants#FEATURE_SECURE_PROCESSING secure XML processing}.      *      * @since Apache Tika 1.17      * @return Transformer      * @throws TikaException when the transformer can not be created      */
specifier|public
specifier|static
name|Transformer
name|getTransformer
