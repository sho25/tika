...
return|;
block|}
comment|/**      * Parses the file at the given path and returns the extracted text content.      *<p>      * Metadata information extracted from the document is returned in       *  the supplied metadata instance.      *      * @param path the path of the file to be parsed      * @param metadata where document's metadata will be populated      * @return extracted text content      * @throws IOException if the file can not be read or parsed      */
specifier|public
name|Reader
name|parse
parameter_list|(
...
return|;
block|}
comment|/**      * Parses the given file and returns the extracted text content.      *<p>      * Metadata information extracted from the document is returned in       *  the supplied metadata instance.      *      * @param file the file to be parsed      * @param metadata where document's metadata will be populated      * @return extracted text content      * @throws IOException if the file can not be read or parsed      * @see #parse(Path)      */
specifier|public
name|Reader
name|parse
parameter_list|(
