...
begin_comment
comment|/**  * Tika to XMP mapping for the Open Document formats:  * Text (.odt), Spreatsheet (.ods), Graphics (.odg) and Presentation (.odp).  */
end_comment
...
argument_list|)
expr_stmt|;
comment|// duplicate properties not mapped:
comment|//		nbImg | 0
comment|//		nbObject | 0
comment|//		nbPage | 1
comment|//		nbPara | 3
