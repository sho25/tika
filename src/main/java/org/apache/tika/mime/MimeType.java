...
literal|0
decl_stmt|;
comment|/**      * Creates a media type with the give name and containing media type      * registry. The name is expected to be valid and normalized to lower      * case. This constructor should only be called by      * {@link MimeTypes#forName(String)} to keep the media type mapping      * up to date.      *      * @param registry the media type registry that contains this type      * @param name media type name      */
name|MimeType
parameter_list|(
name|MimeTypes
name|registry
...
expr_stmt|;
block|}
comment|/**      * Returns the name of this Internet media type.      *       * @return media type name (lower case)      */
specifier|public
name|String
name|getName
parameter_list|()
...
expr_stmt|;
block|}
comment|/**      * Adds a file name pattern for this media type.      *      * @param pattern file name pattern      */
specifier|public
...
expr_stmt|;
block|}
comment|/**      * Returns the file name patterns for this media type.      *       * @return file name patterns      */
specifier|public
specifier|synchronized
name|String
index|[]
...
block|}
comment|//--------------------------------------------------------------< Object>
comment|/**      * Returns the name of this Internet media type.      *      * @return media type name      */
specifier|public
name|String
name|toString
parameter_list|()
