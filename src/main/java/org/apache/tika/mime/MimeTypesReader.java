...
return|;
block|}
comment|/** Read Element named mime-info. */
specifier|private
name|MimeType
index|[]
name|readMimeInfo
...
parameter_list|)
block|{
comment|// Mime Type not valid... just ignore it
if|if
condition|(
name|logger
operator|.
...
return|;
block|}
comment|/** Read Element named glob. */
specifier|private
name|void
name|readGlob
parameter_list|(
...
expr_stmt|;
block|}
comment|/** Read Element named alias. */
specifier|private
name|void
name|readAlias
parameter_list|(
...
expr_stmt|;
block|}
comment|/** Read Element named sub-class-of. */
specifier|private
name|void
name|readSubClassOf
parameter_list|(
