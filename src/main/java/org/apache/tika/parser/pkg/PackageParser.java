...
name|parser
decl_stmt|;
comment|/**      * Returns the parser instance used to parse package entries.      *      * @return entry parser      */
specifier|public
name|Parser
name|getParser
parameter_list|()
...
return|;
block|}
comment|/**      * Sets the parser instance used to parse package entries.      *      * @param parser entry parser      */
specifier|public
name|void
name|setParser
parameter_list|(
