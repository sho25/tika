...
annotation|@
name|Deprecated
comment|/**      * @deprecated use {@link org.apache.tika.eval.textstats.CommonTokens} instead      */
specifier|public
...
return|;
block|}
comment|/**      * @param lang      * @return pair of actual language code used and a set of common      * tokens for that language      */
specifier|public
name|Pair
argument_list|<
name|String
...
argument_list|(
literal|"Common tokens file must have included comment line "
operator|+
literal|" with "
operator|+
name|TERM_FREQS
