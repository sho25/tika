...
condition|)
block|{
comment|//if both files exist and are< minJsonLength, skip em
if|if
condition|(
name|fpsA
operator|.
...
argument_list|)
decl_stmt|;
comment|//array indices for those metadata items handled in
comment|//"that"
name|Set
argument_list|<
name|Integer
...
block|}
block|}
comment|//now try to get any Metadata objects in "that"
