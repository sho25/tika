...
block|}
block|}
comment|/**      * Checks to see if metadata is null or content is empty (null or only whitespace).      * If any of these, then this does no processing, and the fileId is not      * entered into the content table.      *      * @param fileId      * @param contentTags      * @param fieldName      * @param contentsTable      */
specifier|protected
name|void
...
name|warn
argument_list|(
literal|"Problem parsing xhtml in {}; backing off to treat string as text"
argument_list|,
name|evalFilePaths
operator|.
name|getExtractFile
