...
block|}
block|}
comment|/**      * Get the content and record in the data {@link Cols#CONTENT_TRUNCATED_AT_MAX_LEN} whether the string was truncated      *      * @param metadata      * @param maxLength      * @param data      * @return      */
specifier|protected
specifier|static
name|String
name|getContent
...
parameter_list|)
block|{
comment|//So that we have mapping between lang id and common-tokens file names
name|String
name|lang
init|=
name|detectedLanguage
