...
block|{
comment|//reset in case something went horribly wrong
name|System
operator|.
name|setOut
argument_list|(
...
block|}
decl_stmt|;
comment|//report often to make sure
name|TikaCLI
operator|.
name|main
argument_list|(
...
name|indexOf
argument_list|(
literal|"There are 3 file processors still active"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
name|indexOf
argument_list|(
literal|"There are 2 file processors"
argument_list|)
operator|>
operator|-
literal|1
