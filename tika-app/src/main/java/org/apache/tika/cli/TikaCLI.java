...
name|handler
operator|=
name|getMetadataContentHandler
argument_list|()
expr_stmt|;
block|}
else|else
...
return|;
block|}
comment|/**      * Returns a {@link System#out} writer with the configured output encoding.      *      * @see<a href="https://issues.apache.org/jira/browse/TIKA-277">TIKA-277</a>      * @return writer      * @throws UnsupportedEncodingException      *         if the configured encoding is not supported      */
specifier|private
name|Writer
name|getSystemOutWriter
parameter_list|()
