...
specifier|public
name|void
name|testDigiliteFDF
parameter_list|()
throws|throws
name|Exception
block|{
comment|//not to be confused with Adobe's .fdf!
name|assertTypeByData
argument_list|(
literal|"application/vnd.digilite.prolights"
argument_list|,
literal|"testDigilite.fdf"
argument_list|)
expr_stmt|;
name|assertTypeByNameAndData
argument_list|(
...
specifier|public
name|void
name|testPcxDetection
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Single PCX file
name|assertType
argument_list|(
literal|"image/vnd.zbrush.pcx"
argument_list|,
literal|"testPCX.pcx"
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Multi-Page PCX = DCX
name|assertType
argument_list|(
literal|"image/vnd.zbrush.dcx"
argument_list|,
literal|"testDCX.dcx"
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testDolbyDigitalAC3
parameter_list|()
throws|throws
name|Exception
block|{
comment|// By name, both come as AC3, as same extension
name|assertTypeByName
argument_list|(
literal|"audio/ac3"
argument_list|,
...
literal|"audio/ac3"
argument_list|,
literal|"testEAC3.ac3"
argument_list|)
expr_stmt|;
comment|// With data can detect EAC3 subtype
name|assertTypeByData
argument_list|(
literal|"audio/ac3"
argument_list|,
...
name|assertTypeByData
argument_list|(
literal|"application/x-ms-nls"
argument_list|,
literal|"testNLS1.nls"
argument_list|)
expr_stmt|;
name|assertTypeByData
argument_list|(
