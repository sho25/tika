...
name|TikaException
block|{
comment|//make sure to reset pool size because it is being randomly resized during the tests
name|XMLReaderUtils
operator|.
name|setPoolSize
argument_list|(
...
name|assertTypeByData
argument_list|(
literal|"testEXCEL_macro_enabled_template.xltm"
argument_list|,
...
name|assertTypeByData
argument_list|(
literal|"testEXCEL_template.xltx"
argument_list|,
...
argument_list|()
block|{
comment|//TODO: create proper randomized framework that will record seed, etc...
specifier|private
specifier|final
name|Random
name|random
...
argument_list|()
decl_stmt|;
comment|//increase this to the number of files for a true smoke test
comment|//for now, randomly pick 20 files.
name|int
name|toProcess
init|=
literal|20
...
argument_list|(
literal|"testOpenOfficeInAZip.zip"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
