...
argument_list|)
expr_stmt|;
comment|// Should have names and modified dates, but not content types,
comment|//  as zip doesn't store the content types
name|assertEquals
argument_list|(
literal|"testEXCEL.xls"
argument_list|,
...
name|decodeBase64
argument_list|(
literal|"UEsDBBQAAAAIAI+CvUCDo3+zIgAAACgAAAAOAAAAk/qWe4zqg4GDgi50"
operator|+
literal|"eHRr2tj0qulsc2pzRHN609Gm7Y1OvFxNYLHJv6ZV97yCiQEAUEsBAh"
operator|+
literal|"QLFAAAAAgAj4K9QIOjf7MiAAAAKAAAAA4AAAAAAAAAAAAgAAAAAAAA"
operator|+
...
name|assertContains
argument_list|(
literal|"EncryptedDocumentException: stream (encrypted.txt) is encrypted"
argument_list|,
name|values
index|[
literal|0
