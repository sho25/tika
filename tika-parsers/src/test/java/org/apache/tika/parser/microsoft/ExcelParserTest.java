...
argument_list|)
expr_stmt|;
comment|// Won't include missing rows by default
name|assertContains
argument_list|(
literal|"Numbers and their Squares\n\t\tNumber"
argument_list|,
...
expr_stmt|;
block|}
comment|// Request with missing rows
try|try
init|(
name|InputStream
name|input
...
argument_list|)
expr_stmt|;
comment|// Will now have the missing rows, each with a single empty cell
name|String
name|content
init|=
name|handler
...
specifier|public
name|void
name|testHeaderAndFooterNotExtraction
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getResourceAsStream
argument_list|(
literal|"tika-config-macros.xml"
argument_list|)
argument_list|)
decl_stmt|;
name|AutoDetectParser
...
name|getXML
argument_list|(
literal|"testEXCEL_phonetic.xls"
argument_list|)
operator|.
name|xml
argument_list|)
...
name|getXML
argument_list|(
literal|"testEXCEL_labels-govdocs-515858.xls"
argument_list|)
operator|.
name|xml
decl_stmt|;
...
name|getXML
argument_list|(
literal|"testEXCEL_WORKBOOK_in_capitals.xls"
argument_list|)
operator|.
name|xml
decl_stmt|;
...
name|getXML
argument_list|(
literal|"testEXCEL_dateFormats.xls"
argument_list|,
name|p
argument_list|)
operator|.
