...
name|assertContainsCountTimes
argument_list|(
literal|"<p>This is the Author</p>"
argument_list|,
name|content
argument_list|,
literal|1
...
name|assertContainsCountTimes
argument_list|(
literal|"<p>This is an engaging title page</p>"
argument_list|,
name|content
argument_list|,
literal|1
...
name|assertContains
argument_list|(
literal|"<p>My Document Subtitle</p>"
argument_list|,
name|content
argument_list|)
expr_stmt|;
...
name|assertContains
argument_list|(
literal|"<p>This is a link to a local file:<a href=\"file:///C:\\data\\test.png\">test.png</a></p>"
argument_list|,
name|content
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|//TODO: extract this...Note that it is in "Backup" not "Choice"!!!
...
name|cnt
operator|+
literal|" times instead of expected: "
operator|+
name|expectedCount
argument_list|,
name|expectedCount
