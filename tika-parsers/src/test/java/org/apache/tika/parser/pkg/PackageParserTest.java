...
specifier|public
name|void
name|testSpecializations
parameter_list|()
throws|throws
name|Exception
block|{
comment|//Test that our manually constructed list of children of zip and tar
comment|//in PackageParser is current with TikaConfig's defaultConfig.
name|TikaConfig
name|config
init|=
name|TikaConfig
...
argument_list|)
expr_stmt|;
comment|//                System.out.println("\""+type.toString()+"\",");
block|}
block|}
for|for
control|(
