...
expr_stmt|;
block|}
comment|/**      * Check the given InputStream is not closed by the Parser (TIKA-1117).      *      * @throws Exception      */
annotation|@
name|Test
specifier|public
name|void
name|testStreamNotClosed
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// Will throw an Exception if the stream was already closed.
block|}
annotation|@
name|Test
specifier|public
...
name|getText
argument_list|(
literal|"testMasterSlideTable.key"
argument_list|,
name|iWorkParser
argument_list|)
decl_stmt|;
...
name|getText
argument_list|(
literal|"testPagesPwdProtected.pages"
argument_list|,
name|iWorkParser
argument_list|,
name|metadata
...
name|getText
argument_list|(
literal|"testPagesHeadersFootersFootnotes.pages"
argument_list|,
name|iWorkParser
argument_list|)
decl_stmt|;
...
name|getText
argument_list|(
literal|"testPagesHeadersFootersRomanUpper.pages"
argument_list|,
name|iWorkParser
argument_list|)
decl_stmt|;
...
name|getText
argument_list|(
literal|"testPagesHeadersFootersRomanLower.pages"
argument_list|,
name|iWorkParser
argument_list|)
decl_stmt|;
...
name|getText
argument_list|(
literal|"testPagesHeadersFootersAlphaUpper.pages"
argument_list|,
name|iWorkParser
argument_list|)
decl_stmt|;
...
name|getText
argument_list|(
literal|"testPagesHeadersFootersAlphaLower.pages"
argument_list|,
name|iWorkParser
argument_list|)
decl_stmt|;
...
name|getText
argument_list|(
literal|"testPagesComments.pages"
argument_list|,
name|iWorkParser
argument_list|)
decl_stmt|;
...
name|getText
argument_list|(
literal|"testNumbersCharts.numbers"
argument_list|)
decl_stmt|;
name|assertContains
argument_list|(
...
name|expected
init|=
literal|"<table><tr>\t<td>Cell one</td>\t<td>Cell two</td>\t<td>Cell three</td></tr>"
operator|+
literal|"<tr>\t<td>Cell four</td>\t<td>Cell 5</td>\t<td>Cell six</td></tr>"
operator|+
literal|"<tr>\t<td>7</td>\t<td>Cell eight</td>\t<td>5/5/1985</td></tr>"
operator|+
literal|"</table>"
decl_stmt|;
name|String
