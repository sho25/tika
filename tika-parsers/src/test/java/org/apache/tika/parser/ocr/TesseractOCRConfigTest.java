...
specifier|public
name|void
name|testBogusPathCheck
parameter_list|()
block|{
comment|//allow path that doesn't actually exist
name|TesseractOCRConfig
name|config
init|=
operator|new
...
specifier|public
name|void
name|testTrailingSlashInPathBehavior
parameter_list|()
block|{
name|TesseractOCRConfig
name|config
