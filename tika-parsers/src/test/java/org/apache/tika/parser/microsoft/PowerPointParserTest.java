...
name|Ignore
argument_list|(
literal|"not sure why this isn't working"
argument_list|)
specifier|public
name|void
...
name|xml
decl_stmt|;
comment|//"This is the header text" should show up as a notes header
comment|//however, it is currently being extracted while we process notes
comment|//as just a regular HSLFTextParagraph with a value of "false"
comment|//for p.isHeaderOrFooter().
...
specifier|public
name|void
name|testTurningOffMasterFooter
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getXML
argument_list|(
literal|"testPPT_masterFooter.ppt"
argument_list|,
name|context
argument_list|)
operator|.
...
name|getXML
argument_list|(
literal|"testPPT_masterText.ppt"
argument_list|,
name|context
argument_list|)
operator|.
...
name|getXML
argument_list|(
literal|"testPPT_masterText2.ppt"
argument_list|,
name|context
argument_list|)
operator|.
...
argument_list|)
decl_stmt|;
comment|//this tests that we're ignoring text shapes at depth=0
comment|//i.e. POI has already included them in the slide's getTextParagraphs()
name|assertContainsCount
argument_list|(
literal|"Text box1"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|//the WordArt and text box count tests will fail
comment|//if this content is available via getTextParagraphs() of the slide in POI
comment|//i.e. when POI is fixed, these tests will fail, and
comment|//we'll have to remove the workaround in HSLFExtractor's extractGroupText(...)
name|assertContainsCount
argument_list|(
literal|"WordArt1"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|//see below -- need to extract hyperlinks
name|assertContains
argument_list|(
literal|"tika"
argument_list|,
...
name|Ignore
argument_list|(
literal|"until we add smart text extraction"
argument_list|)
annotation|@
name|Test
specifier|public
name|void
name|testSmartArtText
parameter_list|()
throws|throws
name|Exception
block|{
...
name|Ignore
argument_list|(
literal|"until we fix hyperlink extraction from text boxes"
argument_list|)
annotation|@
name|Test
specifier|public
name|void
name|testHyperlinksInTextBoxes
parameter_list|()
throws|throws
name|Exception
block|{
