...
specifier|final
name|String
name|expectedSub8Name
init|=
literal|"\":ua"
decl_stmt|;
specifier|final
name|String
name|expectedSub8Desc
init|=
literal|"[1x17x128x256] eastward_wind (32-bit floating-point)"
decl_stmt|;
name|GDALParser
name|parser
init|=
...
argument_list|)
expr_stmt|;
comment|// If the exit code is 1 (meaning FITS isn't supported by the installed version of gdalinfo, don't run this test.
name|String
index|[]
name|fitsCommand
init|=
