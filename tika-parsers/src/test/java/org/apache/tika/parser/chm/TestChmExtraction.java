...
annotation|@
name|Test
comment|//TODO: redo with new MultiThreadedTikaTest
specifier|public
name|void
...
argument_list|)
expr_stmt|;
comment|/*                new FileFilter() {                     @Override                     public boolean accept(File pathname) {                         if (pathname.getName().toLowerCase(Locale.ENGLISH).endsWith(".chm")) {                             return true;                         } else {                             return false;                         }                     }                 });*/
block|}
block|}
end_class
