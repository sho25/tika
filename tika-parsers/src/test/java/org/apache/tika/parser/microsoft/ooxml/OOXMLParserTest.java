...
specifier|public
name|void
name|testDOCXHeaderFooterNotExtraction
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testSkipHeaderFooter
parameter_list|()
throws|throws
name|Exception
block|{
comment|//now test turning off header/footer
name|OfficeParserConfig
name|config
init|=
operator|new
...
name|Ignore
argument_list|(
literal|"can't tell why this isn't working"
argument_list|)
specifier|public
name|void
name|testTurningOffMasterContent
parameter_list|()
throws|throws
name|Exception
block|{
comment|//now test turning off master content
comment|//the underlying xml has "Master footer" in
comment|//the actual slide's xml, not just in the master slide.
name|OfficeParserConfig
name|config
init|=
operator|new
...
name|getXML
argument_list|(
literal|"testWORD_sdtInTextBox.docx"
argument_list|)
operator|.
name|xml
decl_stmt|;
...
specifier|public
name|void
name|testTurningOffTextBoxExtractionExcel
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|public
name|void
name|testExcelHeaderAndFooterNotExtraction
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|//16 digit number is treated as scientific notation as is the 16 digit formula
name|assertContains
argument_list|(
literal|"1"
operator|+
...
specifier|public
name|void
name|testBigIntegersWGeneralFormatWLocaleIT
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getResourceAsStream
argument_list|(
literal|"tika-config-dom-macros.xml"
argument_list|)
argument_list|)
decl_stmt|;
name|AutoDetectParser
...
expr_stmt|;
block|}
comment|//@Test //use this for lightweight benchmarking to compare xwpf options
specifier|public
name|void
name|testBatch
parameter_list|()
...
argument_list|)
expr_stmt|;
comment|//test only the extraction of the main docx content, not embedded docs
name|parseContext
operator|.
name|set
argument_list|(
...
specifier|public
name|void
name|testInitializationViaConfig
parameter_list|()
throws|throws
name|Exception
block|{
comment|//NOTE: this test relies on a bug in the DOM extractor that
comment|//is passing over the title information.
comment|//once we fix that, this test will no longer be meaningful!
name|InputStream
name|is
init|=
name|getClass
...
name|getResourceAsStream
argument_list|(
literal|"/org/apache/tika/parser/microsoft/tika-config-sax-docx.xml"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//have to set to US because of a bug in POI for $   3.03 in Locale.ITALIAN
name|OfficeParserConfig
name|officeParserConfig
init|=
operator|new
...
name|getRecursiveMetadata
argument_list|(
literal|"testEXCEL_various.xlsb"
argument_list|,
name|parseContext
argument_list|)
decl_stmt|;
...
name|assertContains
argument_list|(
literal|"<td>1.23456789012345E+15</td>"
argument_list|,
name|xml
argument_list|)
expr_stmt|;
...
name|assertContains
argument_list|(
literal|"<a href=\"http://lucene.apache.org/\">http://lucene.apache.org/</a>"
argument_list|,
name|xml
argument_list|)
expr_stmt|;
...
name|assertContains
argument_list|(
literal|"OddLeftHeader OddCenterHeader OddRightHeader"
argument_list|,
name|xml
argument_list|)
expr_stmt|;
name|assertContains
argument_list|(
literal|"EvenLeftHeader EvenCenterHeader EvenRightHeader"
argument_list|,
name|xml
argument_list|)
expr_stmt|;
name|assertContains
argument_list|(
literal|"FirstPageLeftHeader FirstPageCenterHeader FirstPageRightHeader"
argument_list|,
name|xml
argument_list|)
expr_stmt|;
name|assertContains
argument_list|(
literal|"OddLeftFooter OddCenterFooter OddRightFooter"
argument_list|,
name|xml
argument_list|)
expr_stmt|;
name|assertContains
argument_list|(
literal|"EvenLeftFooter EvenCenterFooter EvenRightFooter"
argument_list|,
name|xml
argument_list|)
expr_stmt|;
name|assertContains
argument_list|(
literal|"FirstPageLeftFooter FirstPageCenterFooter FirstPageRightFooter"
argument_list|,
name|xml
argument_list|)
expr_stmt|;
...
name|Exception
block|{
comment|//tests temporary work around until POI 3.17-beta1 is released
name|XMLResult
name|r
init|=
name|getXML
argument_list|(
literal|"testEXCEL_poi-61034.xlsx"
argument_list|)
decl_stmt|;
name|Matcher
name|m
...
name|fail
argument_list|(
literal|"Should only see each sheet once: "
operator|+
name|sheetName
argument_list|)
expr_stmt|;
...
name|assertEquals
argument_list|(
literal|"C:\\Users\\tallison\\Desktop\\working\\TIKA-1945\\"
argument_list|,
name|getXML
argument_list|(
literal|"testEXCEL_diagramData.xlsb"
argument_list|)
operator|.
name|metadata
operator|.
...
name|getXML
argument_list|(
literal|"testEXCEL_diagramData.xlsx"
argument_list|)
operator|.
name|metadata
operator|.
...
name|getXML
argument_list|(
literal|"testPPT_diagramData.pptx"
argument_list|)
operator|.
name|xml
argument_list|)
...
name|assertContains
argument_list|(
literal|"href=\"http://tika.apache.org"
argument_list|,
name|content
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testXLSXPhoneticStrings
parameter_list|()
throws|throws
name|Exception
block|{
comment|//This unit test and test file come from Apache POI 51519.xlsx
comment|//test default concatenates = true
name|assertContains
argument_list|(
literal|"\u65E5\u672C\u30AA\u30E9\u30AF\u30EB \u30CB\u30DB\u30F3"
argument_list|,
...
name|getResourceAsStream
argument_list|(
literal|"tika-config-exclude-phonetic.xml"
argument_list|)
argument_list|)
decl_stmt|;
name|AutoDetectParser
...
name|getXML
argument_list|(
literal|"testWORD_phonetic.docx"
argument_list|)
operator|.
name|xml
argument_list|)
...
name|getRecursiveMetadata
argument_list|(
literal|"testPPT_embeddedMP3.pptx"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
specifier|public
name|void
name|testEmbeddedXLSInOLEObject
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getRecursiveMetadata
argument_list|(
literal|"testPPT_oleWorkbook.pptx"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|getRecursiveMetadata
argument_list|(
literal|"testZIP_corrupted_oom.zip"
argument_list|)
expr_stmt|;
block|}
annotation|@
