...
name|getXML
argument_list|(
literal|"testEXCEL_custom_props.xlsx"
argument_list|,
name|metadata
argument_list|,
name|context
...
name|getRecursiveMetadata
argument_list|(
literal|"testWORD_truncated.docx"
argument_list|,
name|pc
argument_list|)
expr_stmt|;
...
name|getResourceAsStream
argument_list|(
literal|"tika-config-custom-date-override.xml"
argument_list|)
argument_list|)
decl_stmt|;
name|Parser
...
name|getXML
argument_list|(
literal|"testEXCEL_dateFormats.xlsx"
argument_list|,
name|p
argument_list|)
operator|.
