...
name|getResourceAsStream
argument_list|(
literal|"/test-documents/full_encrypted.7z"
argument_list|)
init|)
block|{
name|parser
...
name|fail
argument_list|(
literal|"Shouldn't be able to read a full password protected 7z without the password"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|assertTrue
argument_list|(
literal|"test no password for full encrypted 7z"
argument_list|,
name|ex
argument_list|)
expr_stmt|;
