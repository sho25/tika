...
name|TestCase
block|{
comment|//    private TikaConfig tika = TikaConfig.getDefaultConfig();
specifier|private
name|Tika
name|tika
init|=
...
block|}
block|}
comment|/**      * TIKA-831 Parsers throwing errors should be caught and      *  properly reported      * TODO Disabled, pending a fix for the not serialized exception      */
specifier|public
name|void
name|DISABLEDtestParsingErrorInForkedParserShouldBeReported
parameter_list|()
throws|throws
name|Exception
block|{
