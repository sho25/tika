...
name|assertContains
argument_list|(
literal|"<div class=\"annotation\"><a href=\"http://tika.apache.org/\">"
operator|+
literal|"http://tika.apache.org/</a></div>"
argument_list|,
name|result
operator|.
name|xml
...
name|assertContains
argument_list|(
literal|"test images compressed using JBIG2"
argument_list|,
name|metadatas
operator|.
name|get
...
specifier|public
name|void
name|testXMLProfiler
parameter_list|()
throws|throws
name|Exception
block|{
comment|//test that the xml profiler is not triggered by default
name|List
argument_list|<
name|Metadata
argument_list|>
...
argument_list|)
expr_stmt|;
comment|//test that it is triggered when added to the default parser
...
name|getResourceAsStream
argument_list|(
literal|"/org/apache/tika/parser/pdf/tika-xml-profiler-config.xml"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
...
name|assertEquals
argument_list|(
literal|"CreateDate CreatorTool MetadataDate ModifyDate Thumbnails"
argument_list|,
name|localNames
index|[
literal|2
...
name|assertEquals
argument_list|(
literal|"field form instanceManager subform value"
argument_list|,
name|localNames
index|[
literal|5
...
name|getResourceAsStream
argument_list|(
literal|"/test-documents/testPDF_bad_page_303226.pdf"
argument_list|)
init|)
block|{
name|AUTO_DETECT_PARSER
...
argument_list|)
expr_stmt|;
comment|//now try throwing exception immediately
name|PDFParserConfig
name|config
init|=
operator|new
...
specifier|public
name|void
name|testEmbeddedJPEG
parameter_list|()
throws|throws
name|Exception
block|{
comment|//TIKA-1990, test that an embedded jpeg is correctly decoded
name|PDFParserConfig
name|config
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|//the metadata parse will fail if the stream is not correctly decoded
name|assertEquals
argument_list|(
literal|"1425"
argument_list|,
...
specifier|public
name|void
name|testEmbeddedDocsWithOCROnly
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|//can get dehaystack depending on version of tesseract and/or preprocessing
if|if
condition|(
name|xmlResult
operator|.
...
name|fail
argument_list|(
literal|"couldn't find pdf_haystack or its variants"
argument_list|)
expr_stmt|;
block|}
name|assertContains
...
name|assertNotContained
argument_list|(
literal|"<div class=\"ocr\">pdf_haystack"
argument_list|,
name|xmlResult
operator|.
name|xml
...
specifier|public
name|void
name|testTesseractInitializationWorks
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getResourceAsStream
argument_list|(
literal|"/org/apache/tika/parser/pdf/tika-ocr-config.xml"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//now override the max file size to ocr, and you should get text
name|ParseContext
name|pc
init|=
operator|new
...
name|getResourceAsStream
argument_list|(
literal|"/org/apache/tika/parser/pdf/tika-config.xml"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
...
specifier|public
name|void
name|testInitializationOfNonPrimitivesViaConfig
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getResourceAsStream
argument_list|(
literal|"/org/apache/tika/parser/pdf/tika-config-non-primitives.xml"
argument_list|)
decl_stmt|;
name|assertNotNull
argument_list|(
...
name|assertEquals
argument_list|(
literal|"org.apache.tika.parser.pdf.PDFParser"
argument_list|,
name|pdfParser
operator|.
name|getClass
...
name|Exception
block|{
comment|//different titles in xmp vs docinfo
name|Metadata
name|m
init|=
name|getXML
argument_list|(
literal|"testPDF_diffTitles.pdf"
argument_list|)
operator|.
name|metadata
decl_stmt|;
...
specifier|public
name|void
name|testConfiguringMoreParams
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getResourceAsStream
argument_list|(
literal|"/org/apache/tika/parser/pdf/tika-inline-config.xml"
argument_list|)
init|)
block|{
name|assertNotNull
...
argument_list|)
decl_stmt|;
comment|//make absolutely certain the functionality works!
name|List
argument_list|<
name|Metadata
argument_list|>
...
name|xml
decl_stmt|;
comment|//make sure there is only one page!
...
name|assertContains
argument_list|(
literal|"transport mined materials"
argument_list|,
name|xml
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testFileInAnnotationExtractedIfNoContents
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getRecursiveMetadata
argument_list|(
literal|"testPDFFileEmbInAnnotation_noContents.pdf"
argument_list|)
decl_stmt|;
name|assertEquals
argument_list|(
...
name|getRecursiveMetadata
argument_list|(
literal|"testPDF_bad_page_303226.pdf"
argument_list|,
literal|true
argument_list|)
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|//confirm all works with angles
name|PDFParserConfig
name|pdfParserConfig
init|=
operator|new
...
name|Ignore
argument_list|(
literal|"turn back on if we add file from PDFBOX-52"
argument_list|)
specifier|public
name|void
name|testPDFBox52
