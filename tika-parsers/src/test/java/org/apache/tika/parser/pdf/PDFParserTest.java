...
argument_list|)
expr_stmt|;
comment|//now test wrong password with non sequential parser
name|handler
operator|=
operator|new
name|BodyContentHandler
...
expr_stmt|;
block|}
comment|/**      * tests for equality between traditional sequential parser      * and newer nonsequential parser.      *<p/>      * TODO: more testing      */
annotation|@
name|Test
specifier|public
name|void
...
parameter_list|)
block|{
comment|//silently skip a file that requires a user password
continue|continue;
block|}
catch|catch
parameter_list|(
...
name|TikaException
argument_list|(
literal|"Sequential Parser failed on test file "
operator|+
name|f
argument_list|,
name|e
...
expr_stmt|;
name|String
name|nonSequentialContent
init|=
literal|null
decl_stmt|;
name|Metadata
name|nonSequentialMetadata
init|=
operator|new
name|Metadata
argument_list|()
...
name|TikaException
argument_list|(
literal|"Non-Sequential Parser failed on test file "
operator|+
name|f
argument_list|,
name|e
...
name|getResourceAsStream
argument_list|(
literal|"/test-documents/testPDF_multiFormatEmbFiles.pdf"
argument_list|)
decl_stmt|;
name|RecursiveParserWrapper
name|p
...
name|getResourceAsStream
argument_list|(
literal|"/test-documents/testPDF_XFA_govdocs1_258578.pdf"
argument_list|)
init|)
block|{
name|parser
...
name|Exception
block|{
comment|//        XMLResult r = getXML("testPDF_Version.11.x.PDFA-1b.pdf");
name|Metadata
name|m
init|=
name|getXML
