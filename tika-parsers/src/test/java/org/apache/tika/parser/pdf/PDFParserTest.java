...
condition|)
block|{
comment|//turn back on once PDFBOX-1922 is fixed
comment|//assertFalse(f.getName(), defaultMetadata.equals(sequentialMetadata));
block|}
else|else
block|{
comment|//assertEquals(f.getName(), defaultMetadata, sequentialMetadata);
name|testMetadataEquality
argument_list|(
name|f
operator|.
name|getName
...
expr_stmt|;
block|}
comment|/**      * This is a workaround until PDFBox-1922 is fixed.      * The goal is to test for equality but skip the version issue.      * TODO: get rid of this asap and revert back to this.Metadata.equals(thatMetadata)!      * @return equal or not (ignore version differences)      */
specifier|private
name|void
name|testMetadataEquality
parameter_list|(
...
control|)
block|{
comment|//don't pay attention to differences here for now
if|if
condition|(
name|n
operator|.
...
name|assertEquals
argument_list|(
literal|"unequal multivalued values: "
operator|+
name|fName
argument_list|,
name|thisMetadata
...
block|{
comment|//one is multivalued and the other isn't
name|assertTrue
argument_list|(
literal|"one multivalued, other isn't: "
operator|+
name|fName
argument_list|,
literal|false
...
name|assertTrue
argument_list|(
literal|"null equality of metadata values: "
operator|+
name|fName
argument_list|,
operator|(
...
name|assertEquals
argument_list|(
literal|"metadata values length: "
operator|+
name|fName
argument_list|,
name|thisValues
...
name|assertTrue
argument_list|(
literal|"metadata value; that doesn't contain"
operator|+
name|v
argument_list|,
literal|false
