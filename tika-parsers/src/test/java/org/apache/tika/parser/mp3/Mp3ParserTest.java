...
expr_stmt|;
block|}
comment|/**      * Tests that a file with the last frame slightly      * truncated does not cause an EOF and does      * not lead to an infinite loop.      */
annotation|@
name|Test
specifier|public
name|void
name|testMp3ParsingID3i18nTruncated
parameter_list|()
throws|throws
name|Exception
block|{
...
name|getText
argument_list|(
literal|"testMP3i18n_truncated.mp3"
argument_list|,
name|metadata
argument_list|)
decl_stmt|;
...
specifier|public
name|void
name|testTIKA1589_noId3ReturnsDurationCorrectly
parameter_list|()
throws|throws
name|Exception
block|{
name|assertEquals
argument_list|(
literal|"2455.510986328125"
argument_list|,
name|getXML
argument_list|(
literal|"testMP3noid3.mp3"
argument_list|)
operator|.
name|metadata
operator|.
