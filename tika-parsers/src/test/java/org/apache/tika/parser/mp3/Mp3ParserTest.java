...
expr_stmt|;
block|}
comment|/**      * This test will do nothing, unless you've downloaded the      *  mp3 file from TIKA-424 - the file cannot be      *  distributed with Tika.      * This file has corrupt ID3v2.4 tags in it - the length      *  parameters are written in bytes, not bytes/4      * Check that we can at least read the file without breaking,      *  even if the tags are going to be junk...      */
specifier|public
name|void
name|testTIKA424
parameter_list|()
...
name|assertEquals
argument_list|(
literal|"Plus loin vers l'ouestTPE1\u0000\u0000"
argument_list|,
name|metadata
operator|.
name|get
