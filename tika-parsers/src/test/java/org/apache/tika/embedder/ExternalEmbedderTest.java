...
return|;
block|}
comment|/**      * Gets the original input stream before metadata has been embedded.      *      * @return a fresh input stream      */
specifier|protected
name|InputStream
...
try|try
block|{
comment|// Get the input stream for the test document
name|InputStream
name|origInputStream
init|=
name|getOriginalInputStream
argument_list|()
decl_stmt|;
