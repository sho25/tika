...
argument_list|()
decl_stmt|;
comment|// Use a tagged stream to distinguish between real I/O problems
comment|// and parse errors thrown as IOExceptions by POI.
name|TaggedInputStream
name|tagged
init|=
operator|new
...
parameter_list|)
block|{
comment|// Was this a real I/O problem?
name|tagged
operator|.
name|throwIfCauseOf
argument_list|(
