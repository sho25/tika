...
expr_stmt|;
block|}
comment|/**      * Skips the given number of bytes from the specified input stream.      *       * @param in the input stream      * @param count the number of bytes to skip      * @throws IOException if an IO error occurs      */
specifier|private
specifier|static
name|void
name|skipStream
...
expr_stmt|;
block|}
comment|/**          * Returns the value of the bit group from the given start and end          * index. E.g. ''from'' = 0, ''to'' = 3 will return the value of the          * first 4 bits.          *           * @param the from index          * @param to the to index          * @return the value of this group of bits          */
specifier|public
name|int
name|get
parameter_list|(
