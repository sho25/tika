...
expr_stmt|;
block|}
comment|//tstream will close the fs, no need to close this below
name|tstream
operator|.
...
name|parseEmbedded
argument_list|(
comment|//pass in space character so that we don't trigger a zero-byte exception
operator|new
name|ByteArrayInputStream
argument_list|(
operator|new
