...
condition|)
block|{
comment|// TODO Simply this when on POI 3.8 beta 5
name|URI
name|uri
init|=
name|rel
...
condition|)
block|{
comment|// TODO Workaround for TIKA-705 needed until 3.8 beta 5
try|try
block|{
name|String
name|u
...
argument_list|)
decl_stmt|;
comment|// TODO Simpler version in POI 3.8 beta 5
comment|// PackagePart target = source.getRelatedPart(rel);
name|String
name|type
init|=
name|rel
