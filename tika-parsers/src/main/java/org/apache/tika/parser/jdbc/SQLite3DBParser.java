...
decl_stmt|;
comment|//If the InputStream wasn't a TikaInputStream, copy to this tmp file
name|Path
name|tmpFile
init|=
literal|null
...
argument_list|)
decl_stmt|;
comment|//if this is a TikaInputStream, use that to spool is to disk or
comment|//use original underlying file.
if|if
condition|(
name|tis
operator|!=
...
block|{
comment|//if not TikaInputStream, create own tmpResources.
name|tmpFile
operator|=
name|Files
operator|.
