...
name|create
argument_list|(
literal|"https://raw.githubusercontent.com/tensorflow/tensorflow/122cdce33e3e0a01a7f82645617317530aa571fb/tensorflow/models/image/imagenet/classify_image.py"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
...
specifier|final
name|File
name|defaultScriptFile
init|=
operator|new
name|File
argument_list|(
literal|"tensorflow/tf-objectrec.py"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
specifier|final
name|File
name|defaultModelFile
init|=
operator|new
name|File
argument_list|(
literal|"tensorflow/tf-objectrec-model"
argument_list|)
decl_stmt|;
specifier|private
specifier|static
