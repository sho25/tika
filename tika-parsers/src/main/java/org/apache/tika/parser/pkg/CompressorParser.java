...
name|forName
argument_list|(
literal|"org.brotli.dec.BrotliInputStream"
argument_list|)
expr_stmt|;
name|TMP_SET
operator|.
...
name|forName
argument_list|(
literal|"com.github.luben.zstd.ZstdInputStream"
argument_list|)
expr_stmt|;
name|TMP_SET
operator|.
...
static|static
block|{
comment|//map the mime type strings to the compressor stream names
name|Map
argument_list|<
name|String
argument_list|,
...
argument_list|)
decl_stmt|;
comment|//if we've already identified it via autodetect
comment|//trust that and go with the appropriate name
comment|//to avoid calling CompressorStreamFactory.detect() twice
name|String
name|name
init|=
name|getStreamName
...
expr_stmt|;
block|}
comment|/**      * @param metadata      * @return CompressorStream name based on the content-type value      * in metadata or<code>null</code> if not found      *  ind      */
specifier|private
name|String
name|getStreamName
parameter_list|(
