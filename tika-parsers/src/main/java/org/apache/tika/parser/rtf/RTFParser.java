...
name|TikaException
argument_list|(
literal|"Unexpected RTF parsing error in headless mode"
argument_list|,
name|e
argument_list|)
throw|;
...
name|TikaException
argument_list|(
literal|"GUI environment expected by the javax.swing.text.rtf"
operator|+
literal|" package is not available, see JCR-386;"
operator|+
literal|" try running with -Djava.awt.headless=true"
argument_list|,
name|e
argument_list|)
throw|;
