...
name|IOException
argument_list|(
literal|"Hit end of stream before reading little endian unsigned short."
argument_list|)
throw|;
block|}
return|return
...
name|IOException
argument_list|(
literal|"Hit end of stream before finishing little endian unsigned int."
argument_list|)
throw|;
block|}
name|sum
...
name|IOException
argument_list|(
literal|"Hit end of stream before reading all bytes"
argument_list|)
throw|;
block|}
return|return
