...
literal|20
decl_stmt|;
comment|/**       * The value of padding bytes other than 0 in some DWG files.      */
specifier|private
specifier|static
specifier|final
name|int
index|[]
name|CUSTOM_PROPERTIES_ALT_PADDING_VALUES
init|=
operator|new
name|int
index|[]
...
name|TikaException
block|{
comment|// There should be 4 zero bytes or CUSTOM_PROPERTIES_ALT_PADDING_VALUES next
name|byte
index|[]
name|padding
init|=
