...
index|[]
decl_stmt|;
comment|//name finder is not thread safe https://opennlp.apache.org/documentation/1.5.2-incubating/manual/opennlp.html#tools.namefind
...
argument_list|)
expr_stmt|;
comment|//the same name finder is reused, so clear adaptive data
name|nameFinder
operator|.
