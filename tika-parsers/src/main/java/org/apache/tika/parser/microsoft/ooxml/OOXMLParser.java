...
static|static
block|{
comment|//turn off POI's zip bomb detection because we have our own
name|ZipSecureFile
operator|.
name|setMinInflateRatio
argument_list|(
operator|-
literal|1.0d
argument_list|)
...
name|application
argument_list|(
literal|"vnd.ms-powerpoint.slide.macroenabled.12"
argument_list|)
argument_list|,
name|MediaType
operator|.
name|application
argument_list|(
literal|"vnd.openxmlformats-officedocument.presentationml.slide"
argument_list|)
argument_list|,
name|MediaType
operator|.
...
argument_list|)
comment|//  MediaType.application("x-tika-ooxml")
argument_list|)
argument_list|)
argument_list|)
decl_stmt|;
