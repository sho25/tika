...
begin_comment
comment|/**  * Uses the<a href="http://www.drewnoakes.com/code/exif/">Metadata Extractor</a> library  * to read EXIF and IPTC image metadata and map to Tika fields.  *<p/>  * As of 2.4.0 the library supports jpeg and tiff.  * As of 2.8.0 the library supports webp.  */
end_comment
...
block|{
comment|//TODO: add this to the signatures from the actual parse
specifier|private
specifier|static
specifier|final
name|ParseContext
...
parameter_list|)
block|{
comment|//if height/width appears as "100 pixels", trim " pixels"
if|if
condition|(
name|s
operator|!=
...
name|TikaException
argument_list|(
literal|"Can't process Riff data"
argument_list|,
name|e
argument_list|)
throw|;
...
expr_stmt|;
block|}
comment|// For Compressed Images read from ExifSubIFDDirectory
if|if
condition|(
name|directory
operator|.
...
argument_list|)
decl_stmt|;
comment|//check for null because this could overwrite earlier set width if the value is null
if|if
condition|(
name|width
operator|!=
