...
begin_comment
comment|/**  * Tensor Flow image recogniser which has high performance.  * This implementation uses Tensorflow via REST API.  *<p>  * NOTE : https://wiki.apache.org/tika/TikaAndVision  *  * @since Apache Tika 1.14  */
end_comment
...
name|create
argument_list|(
literal|"http://localhost:8764/inception/v4"
argument_list|)
decl_stmt|;
annotation|@
name|Field
...
argument_list|()
argument_list|,
literal|"/classify/image?topn=%1$d&min_confidence=%2$f"
argument_list|,
name|topN
argument_list|,
name|minConfidence
