...
specifier|static
name|Pattern
name|ALLOWABLE_PAGE_SEPARATORS_PATTERN
init|=
name|Pattern
operator|.
name|compile
...
specifier|static
name|Pattern
name|ALLOWABLE_OTHER_PARAMS_PATTERN
init|=
name|Pattern
operator|.
name|compile
...
return|;
block|}
comment|/**      * Set the path to the Tesseract executable's directory, needed if it is not on system path.      *<p>      * Note that if you set this value, it is highly recommended that you also      * set the path to the 'tessdata' folder using {@link #setTessdataPath}.      *</p>      */
specifier|public
name|void
name|setTesseractPath
parameter_list|(
...
operator|+
literal|"If you trust this value, set it with setTrustedPageSeparator"
argument_list|)
throw|;
block|}
...
name|IllegalArgumentException
argument_list|(
literal|"outputType must not be null"
argument_list|)
throw|;
block|}
name|String
...
name|IllegalArgumentException
argument_list|(
literal|"outputType must be either 'txt' or 'hocr'"
argument_list|)
throw|;
block|}
block|}
...
throw|;
block|}
comment|/**      * @return path to ImageMagick executable directory.      * @see #setImageMagickPath(String imageMagickPath)      */
specifier|public
name|String
name|getImageMagickPath
parameter_list|()
...
return|;
block|}
comment|/**      * Set the path to the ImageMagick executable directory, needed if it is not on system path.      *      * @param imageMagickPath to ImageMagick executable directory.      */
specifier|public
name|void
name|setImageMagickPath
parameter_list|(
