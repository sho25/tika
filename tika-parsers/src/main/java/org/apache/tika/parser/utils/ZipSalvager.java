...
argument_list|)
decl_stmt|;
comment|/**      * This streams the broken zip and rebuilds a new zip that      * is at least a valid zip file.  The contents of the final stream      * may be truncated, but the result should be a valid zip file.      *      * This does nothing fancy to fix the underlying broken zip.      *      * @param brokenZip      * @param salvagedZip      */
specifier|public
specifier|static
name|void
name|salvageCopy
