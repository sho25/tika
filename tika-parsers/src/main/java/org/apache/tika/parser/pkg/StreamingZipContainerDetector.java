...
condition|)
block|{
comment|//can't rely on zae.getSize to determine if there is any
...
argument_list|)
expr_stmt|;
comment|//do anything with an inputstream> MAX_MIME_TYPE?
if|if
condition|(
name|bos
operator|.
...
condition|)
block|{
comment|//odt -- TODO -- check that the results are valid
return|return
name|MediaType
operator|.
name|parse
...
argument_list|)
expr_stmt|;
comment|//TODO: do something if the full stream hasn't been read?
name|MediaType
name|mt
init|=
