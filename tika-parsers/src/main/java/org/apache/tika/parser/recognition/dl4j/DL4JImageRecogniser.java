...
argument_list|)
throw|;
comment|/*# TODO hookup VGGNOTOP by uncommenting following code once the issue is resolved by dl4j team                 modelFile = new File(MODEL_DIR_PREPROCESSED+File.separator+"vgg16_notop.zip"); 				locationToSave= new File(MODEL_DIR+File.separator+"tikaPreprocessed"+File.separator+"vgg16.zip");                     helper = new TrainedModelHelper(TrainedModels.VGG16NOTOP);                     break;*/
case|case
literal|"VGG16"
case|:
name|helper
...
name|TikaConfigException
argument_list|(
literal|"Configuration Error. serialization can be either yes or no."
argument_list|)
throw|;
block|}
if|if
