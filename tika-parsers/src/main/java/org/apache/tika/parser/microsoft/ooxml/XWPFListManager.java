...
name|AbstractListManager
block|{
comment|/**      * Empty singleton to be used when there is no list manager.      * Always returns empty string.      */
specifier|public
specifier|final
specifier|static
name|XWPFListManager
