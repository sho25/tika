...
argument_list|()
decl_stmt|;
comment|// TODO: once we upgrade to POI 3.8 beta 5
comment|// we can avoid this full copy/serialize by
comment|// passing the DirectoryNode instead:
name|IOUtils
operator|.
name|copy
argument_list|(
...
try|try
block|{
comment|// Maybe unwrap OLE10Native record:
name|Ole10Native
name|ole
init|=
operator|new
...
parameter_list|)
block|{
comment|// Not an OLE10Native record
block|}
name|embedded
operator|=
name|TikaInputStream
