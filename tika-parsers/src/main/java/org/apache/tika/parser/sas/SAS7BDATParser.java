...
argument_list|)
expr_stmt|;
comment|// TODO Can we find more general properties for these / move
comment|//  these to more general places?
name|metadata
operator|.
name|set
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// The following SAS Metadata fields are currently ignored:
comment|// compressionMethod
comment|// sessionEncoding
comment|// fileType
comment|// osName -
comment|// osType -
comment|// mixPageRowCount
comment|// headerLength
comment|// pageLength
comment|// rowLength
comment|// Process the column metadata
comment|// TODO Find keys to record the format and the type
for|for
control|(
name|Column
name|c
...
argument_list|()
expr_stmt|;
comment|//TODO: initialize this on the first row and then apply
name|Map
argument_list|<
name|Integer
argument_list|,
