...
condition|)
block|{
comment|// special treatment for anchors
if|if
condition|(
literal|"a"
operator|.
...
block|}
block|}
comment|// check if there are any attributes to process
elseif|else
if|if
condition|(
name|atts
...
argument_list|)
expr_stmt|;
comment|// And resolve relative links for the href& src attributes.
if|if
condition|(
name|normAttrName
operator|.
