...
begin_comment
comment|/**  * This class is intended to handle anything that might contain IBodyElements:  * main document, headers, footers, notes, slides, etc.  *  *<p/>  *  * This class does not generally check for namespaces, and it can be applied  * to PPTX and DOCX for text extraction.  *  *<p/>  * This can be used to scrape content from charts.  It currently ignores  * formula (&lt;c:f/&gt;) elements  *  *<p/>  * This does not work with .xlsx or .vsdx.  *  * TODO: move this into POI?  *  */
end_comment
...
literal|false
decl_stmt|;
comment|//in run or in field. TODO: convert this to an integer because you can have a run within a run
specifier|private
name|boolean
name|inT
init|=
...
argument_list|()
decl_stmt|;
comment|//buffers rt in ruby sections (see 17.3.3.25)
specifier|private
name|boolean
name|inDelText
init|=
