...
name|record
operator|.
name|AbstractEscherHolderRecord
import|;
end_import
...
comment|//HSSFPictureData picture = new HSSFPictureData(blip);
comment|//String mimeType = picture.getMimeType();
comment|//TikaInputStream stream = TikaInputStream.get(picture.getData());
