...
name|IOException
block|{
comment|// TODO: Check for<meta tag in stream. If that exists and is supported, then
comment|// set that in metadata and return.
name|CharsetDetector
name|detector
init|=
operator|new
...
condition|)
block|{
comment|// TODO: check for charset in metadata's content_type
block|}
if|if
condition|(
name|incomingCharset
