...
expr_stmt|;
block|}
comment|//AutoDetectReader can throw exceptions during
comment|//initialization.  If we just created a
comment|//TemporaryResources, we need to make sure to close it.
name|parseImpl
argument_list|(
name|stream
argument_list|,
...
block|}
block|}
comment|/**      * Whether or not to extract contents in script entities.      * Default is<code>false</code>      *      * @param extractScripts      */
annotation|@
name|Field
specifier|public
name|void
