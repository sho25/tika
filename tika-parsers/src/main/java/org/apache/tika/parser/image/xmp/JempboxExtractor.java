...
block|{
comment|//TODO: change signature to require parsecontext from parse
specifier|private
specifier|static
specifier|final
name|ParseContext
...
expr_stmt|;
block|}
comment|/**      * Tries to extract Dublin Core schema from XMP.  If XMPMetadata is null      * or if the DC schema is null, this will return without throwing an exception.      *      * @param xmpMetadata XMPMetadata to process      * @param metadata Tika's metadata to write to      */
specifier|public
specifier|static
name|void
name|extractDublinCore
