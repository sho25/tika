...
begin_comment
comment|/**  * Parser for the Better Portable Graphics )BPG) File Format.  *<p/>  * Documentation on the file format is available from  * http://bellard.org/bpg/bpg_spec.txt  */
end_comment
