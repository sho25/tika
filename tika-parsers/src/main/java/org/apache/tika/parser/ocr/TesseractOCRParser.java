...
block|}
decl_stmt|;
comment|// If Tesseract is not on the path, do not try to run OCR.
if|if
condition|(
operator|!
name|ExternalParser
...
block|}
block|}
comment|// TIKA-1445 workaround parsers
specifier|private
specifier|static
name|Parser
name|_TMP_IMG_PARSER
