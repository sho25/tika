...
condition|)
block|{
comment|// Indicates an invalid character in the charset
comment|// Bump the ngram count up a bit to indicate uncertainty
name|ngramCount
operator|+=
literal|4
expr_stmt|;
...
parameter_list|)
block|{
comment|// Return true if byte is any of these:
comment|//
comment|//   {(byte)0xb2,(byte)0xb3,(byte)0xb4,(byte)0xb5,(byte)0xb7,(byte)0xb8}
comment|//
comment|// NOTE: 0xb2 is -78; 0xb8 is -72:
return|return
operator|(
name|b
operator|<=
