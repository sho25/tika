...
begin_comment
comment|/*  ****************************************************************************  * Copyright (C) 2005-2013, International Business Machines Corporation and *  * others. All Rights Reserved.                                             *  ************************************************************************** *  *  */
end_comment
...
begin_comment
comment|/**  * This class recognizes single-byte encodings. Because the encoding scheme is so  * simple, language statistics are used to do the matching.  */
end_comment
...
comment|// To avoid mis-detection, we skip many of the control characters in the 0x00-0x3f range
specifier|protected
specifier|static
name|byte
index|[]
...
expr_stmt|;
block|}
comment|/**          * @param lang language to find          * @return the index into CharsetRecog_8859_1.ngrams_8859_1 that matches his language;          * throws IllegalArgumentException if language can't be found          */
specifier|static
name|int
name|findLangIndex
parameter_list|(
...
block|}
block|}
comment|//The EBCDIC codes were removed from ICU4js trunk as of at least July 26, 2016.
specifier|static
class|class
