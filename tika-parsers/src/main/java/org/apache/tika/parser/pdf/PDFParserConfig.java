...
expr_stmt|;
block|}
comment|/**      * Extract font names into a metadata field      * @param extractFontNames      */
specifier|public
name|void
name|setExtractFontNames
parameter_list|(
...
return|;
block|}
comment|/**      * Image quality used to render the page image for OCR.      * This does not apply to all image formats      */
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      * @see #setExtractActions(boolean)      * @return whether or not to extract PDActions      */
specifier|public
name|boolean
...
return|;
block|}
comment|/**      * The maximum amount of memory to use when loading a pdf into a PDDocument. Additional buffering is done using a      * temp file.      * @return      */
specifier|public
name|long
...
return|;
block|}
comment|/**      * @deprecated use {@link #setMaxMainMemoryBytes(long)}      * @param maxMainMemoryBytes      */
annotation|@
name|Deprecated
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/**      *<p>      *     Whether to call<code>System.setProperty("sun.java2d.cmm", "sun.java2d.cmm.kcms.KcmsServiceProvider")</code>.      *     KCMS is the unmaintained, legacy provider and is far faster than the newer replacement.      *     However, there are stability and security risks with using the unmaintained legacy provider.      *</p>      *<p>      *     Note, of course, that this is<b>not</b> thread safe.  If the value is<code>false</code>      *     in your first thread, and the second thread changes this to<code>true</code>,      *     the system property in the first thread will now be<code>true</code>.      *</p>      *<p>      * Default is<code>false</code>.      *</p>      * @param setKCMS whether or not to set KCMS      */
specifier|public
name|void
name|setSetKCMS
parameter_list|(
