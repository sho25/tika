...
specifier|public
name|void
name|testEmptyParser
parameter_list|()
throws|throws
name|Exception
block|{
comment|//As of Tika 1.23, we're no longer returning 415 for file types
comment|//that don't have a parser
...
comment|//still returtestXDP.xdpns BAD_REQUEST.  We may want to
